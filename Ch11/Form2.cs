...
namespace Ch11
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            members.Add(new Member("a101", "김춘추", "010-1234-1002", 21));
            members.Add(new Member("a101", "장보고", "010-1234-1003", 34));
            members.Add(new Member("a101", "강감찬", "010-1234-1004", 44));
            members.Add(new Member("a101", "이순신", "010-1234-1005", 54));
