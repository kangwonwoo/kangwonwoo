 ...
 * 날짜 : 2022/06/15 
 * 이름 : 강원우
 * 내용 : 컬렌션 HashTable/Dictionary 실습
 */
namespace Ch07
{
    internal class _4_HashTable
    {
        ...
        {
            // 테이블 생성
            Hashtable table = new Hashtable();   // using System Collections 추가해주기

            // K-V 쌍 데이터 저장 (Key-Value)
            table['A'] = "Apple";
            table['B'] = "Banana";
            table['C'] = "Cherry";
            ...
            // 데이터 입력1
            dic['A'] = "Apple";   //  = dic.Add('A', "Apple");
            dic['B'] = "Banana";  //  = dic.Add('B', "Banana");
            dic['C'] = "Cherry";  //  = dic.Add('c', "Cherry");
            ...
            // 한국 사과 출력
            Console.WriteLine("apples[101] : "+ d1[101]);  // 내가 한 문제풀이

            Dictionary<int, Apple> d = apples[0];  // 풀이
            Apple a = d[101];
            a.show();
